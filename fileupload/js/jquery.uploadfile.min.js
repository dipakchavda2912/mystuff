...
(function (b) {
    if (b.fn.ajaxForm == undefined) {
        b.getScript("http://localhost/mystuff/fileuploads/flupload/js/jquery.form.js")
    }
    var a = {};
    ...
    b.fn.uploadFile = function (t) {
        ...
        function q(y, B, D, u) {
            ...
            if (D.nestedForms) {
                ...
                w.appendTo(b("body"));
                w.css({margin: 0, padding: 0, display: "block", position: "absolute", left: "-250px"});
        ...
        function n(z, y, u, w, A) {
            var x = null;
            var v = {cache: false, contentType: false, processData: false, forceSync: false, type: y.method, data: y.formData, formData: y.fileData, dataType: y.returnType, beforeSubmit: function (F, C, E) {
